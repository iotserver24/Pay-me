        ...
        <div className="max-w-7xl mx-auto animate-fade-in">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex gap-4">
              <Link href="/admin/api" className="bg-dark-800/50 hover:bg-white/5 border border-white/10 text-white px-4 py-2 rounded-lg transition flex items-center gap-2">
